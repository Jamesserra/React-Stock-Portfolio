  ...
  render() {
    ...
    return(
      <form className="col-12 mt-2 mb-4" onSubmit={this.handleSubmit}>
        <input className="mx-2" name="name" type="text" placeholder="Name" value={name} onChange={this.handleChange} required />
            <input className="mx-2" name="shares_owned" type="number" placeholder="Shares" value={shares_owned} onChange={this.handleChange} />
            <input className="mx-2" name="cost_per_share" type="number" placeholder="Cost" value={cost_per_share} onChange={this.handleChange} />
            <input className="mx-2" name="market_price" type="number" placeholder="Price" value={market_price} onChange={this.handleChange} />
            <button className="btn mb-1 btn-primary btn-sm">Add</button>
      </form>
    )
  }
}
